            ...
            switch (this.render)
            {
                case "CANVAS":
                    ...
                    {                        
	                    ...
	                    s.push('<div id="node_weight_' + node.id + '" class="weight_div_cls" onclick="focusInput(event)">权重<input style="width:40px" class="node_weight_cls" id="node_weight_input_'
	                     + node.id + '" disable="' + node.canCollapse +'"/>%</div></div>');
                    }
                    s.push('</div>');        
                    break;
