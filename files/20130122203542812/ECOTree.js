...
|	     			   Software ó Practice and Experience 10, 1980 553-561.    
|                      (Obtained from C++ User's journal. Feb. 1991)                                                                              
|					   
|     Last updated: 2006-10-26
|     Version: 1.0
|
|      guozc updated: 2009-10-20
|      version:1.1 ‘ˆº”Ω⁄µ„…œœ‘ æÕº∆¨≤¢ø…≈‰÷√π¶ƒ‹
\------------------------------------------------------------------------------------------*/
...
ECOTree.prototype.add = function (id, pid, dsc,img,target, w, h, c, bc, meta) {	
	...
	var node = new ECONode(id, pid, dsc,vImg,tg,nw, nh, color, border, metadata);	//New node creation...
